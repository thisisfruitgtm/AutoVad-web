  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-gray-900/50 border border-gray-800 rounded-2xl overflow-hidden flex my-auto">
      ...
      <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
        ...
        <Button onClick={handleGoogleSignIn} variant="outline" className="w-full bg-gray-800 border-gray-700 hover:bg-gray-700 flex items-center gap-2" disabled={loading}>
